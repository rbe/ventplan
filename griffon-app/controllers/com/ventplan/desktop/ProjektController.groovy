...
class ProjektController {
    ...
    private void makePrinzipskizze() {
        try {
            ...
            String fortluft = artikelfurAussenluftauslass()
            // Zentralgerät
            ...
            if (b != null && b.size() > 0) {
                ...
                prinzipskizzeGrafik = new File(FilenameHelper.getVentplanDir(), FilenameHelper.cleanFilename("${model.vpxFilename}_Prinzipskizze.png"))

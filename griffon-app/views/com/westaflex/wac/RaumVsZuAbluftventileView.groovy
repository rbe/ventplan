...
panel(id: "raumVsZuAbluftventile", layout: new MigLayout("fillx", "[left]para[right]para[left]para[fill]para[left]", "[fill]")) {
	
	table(id: "raumVsZuAbluftventileTable", constraints: "cell 0 0 5 1", model: model.createRaumVsZuAbluftventileModel(), selectionMode: javax.swing.ListSelectionModel.SINGLE_SELECTION) {
	}

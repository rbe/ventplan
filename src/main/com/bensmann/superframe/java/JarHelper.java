...
/**
 * JarHelper: JarHelper maps all resources included in a
...
public final class JarHelper {
    ...
    /**
     * creates a JarHelper. It extracts all resources from a Jar
     * into an internal hashtable, keyed by resource names.
     * @param jarFileName a jar or zip file
     */
    public JarHelper(String jarFileName) {
        this.jarFileName = jarFileName;
        init();
    }
    
    public JarHelper(ZipInputStream zipInputStream) {
     ...
     * files. Now, by using JarHelper, you could extract, create, and display
     * those images on-the-fly.
     * <pre>
     *     ...
     *     JarHelper JR=new JarHelper("GifBundle.jar");
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length!=2) {
            ...
            System.err.println("usage: java JarResources <jar file name>" +
                    " <resource name>");
        ...
        JarHelper jr = new JarHelper(args[0]);

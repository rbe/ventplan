...
taskkill /f /im soffice* >nul

rem Update
xcopy update\conf\* conf /e /c /i /f /r /y
xcopy update\sql\* sql /e /c /i /f /r /y
xcopy update\lib\* lib /e /c /i /f /r /y
rmdir /s /q update >>wac.log

rem Start
java -cp "%CLASSPATH%" -Djava.library.path="%OOOL%" griffon.swing.SwingApplication >>wac.log
